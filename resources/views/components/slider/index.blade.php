<style>
    ...
    */
    ...
    .jssorb21 div, .jssorb21 div:hover, .jssorb21 .av {
        ...
        color: white;
        font-size: 12px;
        background: url(/img/jssor/b21.png) no-repeat;
        overflow: hidden;
        cursor: pointer;
    }
...
<script type="text/javascript" src="/js/libraryDevelop/jquery-1.9.1.min.js"></script>
<!-- use jssor.slider.mini.js (40KB) instead for release -->
<!-- jssor.slider.mini.js = (jssor.js + jssor.slider.js) -->
<script type="text/javascript" src="/js/libraryDevelop/jssor.js"></script>
<script type="text/javascript" src="/js/libraryDevelop/jssor.slider.js"></script>
<script>
    jQuery(document).ready(function ($) {
        ...
        function ScaleSlider() {
            ...
            var bodyWidth = document.getElementById('mainContainer').clientWidth-40;
            //bodyWidth = 200;
            if (bodyWidth)
